...
int main() {
  ...
  threshold(resultadobottom,resultadobottom,50,255,CV_THRESH_BINARY);//binarizacao
  da imagem

  Mat resultadofinal;
  medianBlur(resultadobottom,resultadofinal,1);//filtragem mediana da imagem

  threshold(resultadofinal,resultadofinal,50,255,CV_THRESH_BINARY_INV);//binarizacao
  inversa da imagem
